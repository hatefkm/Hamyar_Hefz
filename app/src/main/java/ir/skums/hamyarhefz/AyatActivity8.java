...
import ir.skums.hamyarhefz.ayatnavigationbar.NamSoreFragment8;
...
public class AyatActivity8 extends AppCompatActivity {
    ...
    public void btnSoal(View view) {
        Intent intent = new Intent(AyatActivity8.this, Soal1ActivityJ9.class);
