...
public class EbJ7Activity extends AppCompatActivity {
    ...
    private void showJozhaFromDatabase() {
        ...
        cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=1",null);
    ...
    public void btn_Badi(View view) {
        ...
        if (i==1){
            ...
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=2",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=3",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=4",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=5",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=6",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=7",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=8",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=9",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=10",null);
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=11",null);
    ...
    public void btn_qabli(View view) {
        ...
        if (i==1){
            ...
            adapter.notifyDataSetChanged();
            adapter.clear();
            cursorJozha=database.rawQuery("SELECT * FROM AyatEbJ7 WHERE id=12",null);
