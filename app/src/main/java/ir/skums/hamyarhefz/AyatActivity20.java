...
import ir.skums.hamyarhefz.ayatnavigationbar.NamSoreFragment20;
...
public class AyatActivity20 extends AppCompatActivity {
    ...
    public void btnSoal(View view) {
        Intent intent = new Intent(AyatActivity20.this, Soal2ActivityJ21.class);
