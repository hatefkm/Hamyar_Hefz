...
public class AyatActivity22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ayat22);
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.framecontainer, new HomeFragment22()).commit();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getSupportFragmentManager().beginTransaction().replace(R.id.FrameLayoutPlay, new PlayPanleFragment22()).addToBackStack(null).commit();
    ...
    public void btnSoal(View view) {
        Intent intent = new Intent(AyatActivity22.this,Soal1Activity.class);
